...
function handle_led_changes()
    ...
    set_led(LED.FCU_ALT, check_datarefs(DATAREFS['AP']) and check_datarefs(DATAREFS['ALT'], 1))
    set_led(LED.FCU_VS, check_datarefs(DATAREFS['AP']) and check_datarefs(DATAREFS['VS'], 1))
